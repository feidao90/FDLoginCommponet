...
@property (nonatomic,strong) VOLoginViewController *currentLoginVC;
@end
...
-(void)setCurrentLoginVC:(VOLoginViewController *)currentLoginVC
{
...
- (void)presentLoginView:(NSNumber *)num
{
    dispatch_async(dispatch_get_main_queue(), ^{
        self.currentLoginVC = [[VOLoginViewController alloc] init];
